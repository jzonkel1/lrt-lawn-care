...
SERVICES = [
 ...
 dict(
  ...
  photo="g-entry-beds.webp", photo_alt="An entry walkway with trimmed shrubs and a clean rock border",
  photo_cap="Entry beds and a bordered walkway, trimmed and maintained.",
  faqs=[
 ...
 dict(
  ...
  hero_photo="svc-trimming.webp", hero_alt="A home entry walkway with trimmed shrubs and a clean rock border",
  intro=[
 ...
 dict(
  ...
  photo=None, photo_alt=None, photo_cap=None,
  faqs=[
  ...
  <div class="shell">
    ...
    <div class="foot-bot">
      <span>&copy; <span id="yr">2026</span> {BIZ_LLC} All rights reserved. &middot;
        ...
        <a href="/contact/" style="color:inherit">Contact</a></span>
...
<section class="sec cta-band">
  <div class="shell">
    <div class="cta-in rv">
      <p class="eyebrow" style="justify-content:center;margin-bottom:1.1rem">Free quote &mdash; no obligation</p>
      <h2>{h2}</h2>
      <p>{p}</p>
      <div class="ph-cta">
        <a class="btn btn-call" href="{TEL}">{ic("phone2")}Call {PHONE}</a>
  ...
  <div class="hero-in">
   <div class="hero-copy">
    ...
    <div class="hero-chips">
      <span class="chip">{ic("shield")}<span class="lg">$1M / $2M insured</span><span class="sm">Fully insured</span></span>
      <span class="chip">{ic("calendar")}<span class="lg">Weekly &amp; bi-weekly</span><span class="sm">Weekly &amp; bi-weekly</span></span>
      <span class="chip">{ic("card")}<span class="lg">Card on file</span><span class="sm">Card on file</span></span>
      <span class="chip">{ic("building")}<span class="lg">12 years in the field</span><span class="sm">12 years in the field</span></span>
    </div>
   </div>
...
<section class="sec stripes" id="services">
  <div class="shell">
    ...
    <div style="text-align:center;margin-top:2.2rem" class="rv">
      <a class="btn btn-ghost" href="/services/">See all services, including mulch, sod &amp; pressure washing {ic("arrow")}</a>
    </div>
  </div>
</section>
...
<section class="sec stripes">
  <div class="shell">
    <div class="sec-head rv">
      ...
      <p>Every photo on these cards is LRT&rsquo;s own work &mdash; no stock, no borrowed jobs.</p>
    </div>
    <div class="svc-grid">{cards}</div>
  </div>
</section>
...
<section class="sec" style="background:var(--ink-2);border-block:1px solid var(--line)">
  <div class="shell">
    <div class="reel-row">
    <div class="sec-head rv">
      <p class="eyebrow">On the route</p>
      <h2>What a finished property actually looks like.</h2>
      <p>Two stops from a normal week &mdash; a commercial lot and a residential route, filmed on the way back to the truck.</p>
    </div>
    <div class="reel rv">
      <div class="reel-win">
        <div class="reel-track" id="reelTrack">
          <figure class="reel-item" tabindex="0" role="button" aria-label="Expand: commercial grounds clip">
            <video src="/assets/clip-commercial.mp4" poster="/assets/clip-commercial-poster.webp" muted loop playsinline preload="metadata"></video>
            <span class="reel-expand">{ic("expand")}</span>
            <figcaption>Commercial grounds &mdash; edged to the curb line</figcaption>
          </figure>
          <figure class="reel-item" tabindex="0" role="button" aria-label="Expand: residential route clip">
            <video src="/assets/clip-residential.mp4" poster="/assets/clip-residential-poster.webp" muted loop playsinline preload="metadata"></video>
            <span class="reel-expand">{ic("expand")}</span>
            <figcaption>Residential route &mdash; walk, curb and ditch</figcaption>
          </figure>
        </div>
      </div>
      <div class="reel-nav">
        <button type="button" id="reelPrev" aria-label="Previous clip"><svg class="ic" viewBox="0 0 24 24" style="transform:rotate(180deg)"><path d="m9 18 6-6-6-6"/></svg></button>
        <button type="button" id="reelNext" aria-label="Next clip">{ic("chev")}</button>
      </div>
    </div>
    </div>
  </div>
...
<section class="sec">
  <div class="shell">
    ...
    <div class="split" style="margin-top:3.4rem">
      ...
      <figure class="split-photo rv">
        <img src="/assets/g-commercial-lot.webp" alt="A newly picked-up commercial property with the grounds mowed to the fence line" loading="lazy">
        <figcaption>A commercial property on the route.</figcaption>
      </figure>
    </div>
  </div>
</section>
