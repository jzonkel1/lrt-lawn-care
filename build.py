...
<section class="hero" id="top">
  <div class="hero-bg">
    ...
    <!-- desktop-only ambient loop (site.js attaches the src; static image stays
         for mobile, reduced-motion, and while the video buffers) -->
    <video class="hero-vid" id="heroVid" muted loop playsinline preload="none" data-src="/assets/hero-loop.mp4" aria-hidden="true"></video>
  </div>
