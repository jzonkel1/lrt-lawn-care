...
SERVICES = [
 ...
 dict(
  ...
  card_photo="svc-commercial-grounds.webp", card_alt="Manicured beds and lawn at the entrance of a commercial building",
...
# Most motion first — the near-static clips sit at the end. clip-commercial
# was cut entirely (slow pan, showed nothing).
HOME_REELS = [
