...
<section class="sec hreel-sec stripes">
  <div class="shell">
    <div class="sec-head rv" style="margin-bottom:1.9rem">
      <p class="eyebrow mswap"><span class="lg">Straight from the job site</span><span class="sm">From the job site</span></p>
...
<section class="hero" id="top">
  ...
  <div class="hero-in">
   <div class="hero-copy">
    ...
    <div class="trust">
      <div class="titem"><span class="tic">{ic("shield")}</span><span><b>Fully insured</b><i>$1M / $2M coverage</i></span></div>
      <div class="titem"><span class="tic">{ic("calendar")}</span><span><b>Weekly &amp; bi-weekly</b><i>A locked-in route day</i></span></div>
      <div class="titem"><span class="tic">{ic("card")}</span><span><b>Card on file</b><i>Billing on autopilot</i></span></div>
...
<!-- ============ CONTACT CARDS ============ -->
<section class="sec stripes" style="padding-bottom:0">
  <div class="shell">
